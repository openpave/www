 ...
 *
 *  $OpenPave: www/license.php,v 1.2 2007/02/08 19:18:04 reg Exp $
 *
...
ACADEMIC DEVELOPMENT AND DISTRIBUTION LICENSE (ADDL) Version 1.0
    ...
    1. DEFINITIONS
        ...
        any of the following:
            ...
            D. Any new file that is required by other Modifications in order
            to build or function as intended by the Contributor.

        1.11. "Original Software" means the Source Code and Executable form
        of computer software code that is originally released under this
        License.

        1.12. "Patent Claims" means any patent claim(s), now owned or
        hereafter acquired, including without limitation, method, process,
        and apparatus claims, in any patent Licensable by grantor.

        1.13. "Source Code" means (a) the common form of computer software
    ...
    3. DISTRIBUTION OBLIGATIONS
        ...
        part on the Covered Software, which You have Modified, or results
        obtained using such Covered Software, You must ensure that any
        Modifications which You have made are also be made available in
        Source Code form and that Source Code form must be distributed only
        under the terms of this License.  You must inform recipients of any
        such Academic Work as to how they can obtain such Covered Software
    ...
    where Initial Developer is a citizen (or registered, in the case of
    corporate entities), as noted below, except to the extent applicable
    law, if any, provides otherwise.  Any litigation relating to this
    License shall be subject to the jurisdiction of the nearest suitable
    courts to the current residence or registered address of the Initial
    Developer, except if both parties agree to a change of venue prior to
    the commencement court proceedings.  The losing party shall be
    responsible for costs, including, without limitation, court costs and
    reasonable attorneys' fees and expenses.  Should a legal dispute arise,
    in which You are involved, You agree to seek alternative means of
    dispute resolution, such as arbitration, to minimize legal costs before
    resorting to litigation.  Any law or regulation which provides that the
    ...
    compliance with the export control laws and regulations of any country
    involved when You use, distribute or otherwise make available any
    Covered Software.

    The Source Code to which this copy of the License was attached is
...
<?php
FinaliseHTML('$OpenPave: www/license.php,v 1.2 2007/02/08 19:18:04 reg Exp $');
?>